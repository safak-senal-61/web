    ...
    if (authIsLoading) {
      return (
        <div className="flex items-center gap-x-2 sm:gap-x-3">
          <div className="h-8 w-8 animate-pulse rounded-lg bg-slate-200 dark:bg-slate-700 hidden sm:block"></div>
          ...
          <>
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent
                ...
                side="bottom"
                sideOffset={8}
                className="w-80 sm:w-96 bg-white dark:bg-slate-800 
                           border border-slate-200 dark:border-slate-700
                           shadow-2xl rounded-2xl p-0 max-h-[70vh] overflow-hidden
                           z-50"
              ...
              >
                ...
                <div className="max-h-64 overflow-y-auto">
                  {notifications.length > 0 ? (
                    notifications.map((notification) => (
                      <DropdownMenuItem
                        key={notification.id}
                        className="p-4 hover:bg-slate-100 dark:hover:bg-slate-700 
                                   focus:bg-slate-100 dark:focus:bg-slate-700 
                                   cursor-pointer border-b border-slate-200 dark:border-slate-700 
                                   last:border-b-0"
                        onSelect={(e) => {
                          // Prevent default selection behavior if needed
                          console.log('Notification clicked:', notification.id);
                        }}
                      >
                        <div className="flex items-start space-x-3 w-full">
                          <div className={`w-2.5 h-2.5 rounded-full mt-1.5 flex-shrink-0 ${
                            notification.unread ? 'bg-blue-500 dark:bg-blue-400' : 'bg-slate-400 dark:bg-slate-600'
                          }`}></div>
                ...
                <DropdownMenuItem asChild className="p-0">
                  <Link 
                    href="/notifications" 
                    className="flex items-center justify-center w-full p-3 text-sm 
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button 
                  ...
                  className="relative h-10 w-10 rounded-full p-0 
                             ...
                             ring-2 ring-transparent hover:ring-blue-500/30 
                             dark:hover:ring-blue-500/50 focus:ring-blue-500/30 
                             dark:focus:ring-blue-500/50 focus:outline-none"
                  type="button"
                >
                  ...
                  <div className="absolute -bottom-0.5 -right-0.5 w-3.5 h-3.5 
                                  bg-green-500 dark:bg-green-400 border-2 
                                  border-white dark:border-slate-900 rounded-full animate-pulse"></div>
                </Button>
              </DropdownMenuTrigger>
              <DropdownMenuContent
                align="end"
              ...
              >
                ...
                <DropdownMenuSeparator className="border-slate-200 dark:border-slate-700 my-1.5" />
                <DropdownMenuItem asChild>
                  <Link 
                    ...
                    className="flex items-center w-full text-slate-700 dark:text-slate-300 
                               ...
                               cursor-pointer rounded-lg m-1 p-2.5 sm:p-3"
                  >
                ...
                <DropdownMenuItem 
                  ...
                  className="text-red-600 dark:text-red-400 
                             ...
                             focus:bg-red-100 dark:focus:bg-red-500/20 
