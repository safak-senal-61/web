    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 flex items-center justify-center p-4">
      <div className="max-w-2xl mx-auto text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-md mx-auto">
          ...
          >
            <MessageCircle className="h-6 w-6 text-blue-600 mx-auto mb-2 group-hover:scale-110 transition-transform" />
          ...
          >
            ...
            <p className="text-sm font-medium text-gray-900">Arkadaşlar</p>
          </Link>
          ...
          >
            <div className="w-6 h-6 bg-gradient-to-r from-green-400 to-blue-500 rounded-full mx-auto mb-2 group-hover:scale-110 transition-transform" />
